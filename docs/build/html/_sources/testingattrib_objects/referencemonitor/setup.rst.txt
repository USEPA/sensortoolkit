...
the recorded sensor data format into the sensortoolkit `Reference Data Formatting Scheme (R-DFS) <../../data_structures/sdfs.html>`_.
...
Continuing with the `evaluation.py` example, the setup module can be called via the
...
.. tabbed:: AirNowTech
  ...
  The following steps below walk through the setup process. The example below
  describes the setup process for a reference data file downloaded from AirNowTech
  ...
  **4. Copying Data files**
    ...
    .. code-block:: console
      ...
      Destination Directory:
      ..C:\Users\...\Documents\sensortoolkit_testing\Data and Figures\reference_data\airnowtech\raw\Burdens_Creek_370630099
  ...
  **5. Pre-processing AirNowTech Datasets**

    .. code-block:: console

      ======================= Pre-process AirNowTech Datasets ======================
      ==============================================================================
      Writing AirNowTech dataframes to csv files
  ...
  **6. Saving the Setup Configuration to** ``setup.json``
    ...
    .. code-block:: console
      ...
      ..writing setup configuration to the following path:
      C:\Users\...\Documents\sensortoolkit_testing\Data and Figures\reference_data\airnowtech\raw\Burdens_Creek_370630099\reference_setup.json
...
.. tabbed:: AQS
  ...
  **3. Saving the Setup Configuration to** ``setup.json``
    ...
    .. code-block:: console
      ...
      ..writing setup configuration to the following path:
      C:\Users\...\Documents\sensortoolkit_testing\Data and Figures\reference_data\aqs\raw\Triple_Oak_371830021\reference_setup.json
...
.. tabbed:: AirNow
  ...
  **3. Saving the Setup Configuration to** ``setup.json``
    ...
    .. code-block:: console
      ...
      ..writing setup configuration to the following path:
      C:\Users\...\Documents\sensortoolkit_testing\Data and Figures\reference_data\airnow\raw\Burdens_Creek_370630099\reference_setup.json
